...
export default function Upload({
  ...
  const onDrop = (acceptedFiles) => {
    if (acceptedFiles.length > 0) {
      ...
      console.log("Dropped file: ", file); // Debugging log
      previewFile(file);
  ...
  const { getRootProps, getInputProps, isDragActive } = useDropzone({
    ...
    onDrop,
    multiple: false, // Make sure only one file is selected at a time
  });
  ...
  const previewFile = (file) => {
    ...
    reader.onloadend = () => {
      ...
      console.log("Preview source:", reader.result); // Debugging log
    };
  ...
  return (
    <div className="flex flex-col space-y-2">
      ...
      <div
        ...
        {...getRootProps()} // Attach root props to the container
      >
